...
$upd_barang= mysqli_query($koneksi,"select  *  from pembayaran where kd_pembayaran ='$id_update_barang' ");
...
<div> 
  ...
  <form action="edit_proses_pembayaran.php" class="form-container" method="post" align="center">
    <h1>Edit</h1>

    <table border="0" align="center">
          <tr>
              <td align="center" class="pink">kode pembayaran</td>
              <td>:</td>
          <td align="center">
              <input readonly type="text" name="kd_pembayaran" value="<?php echo $upd['kd_pembayaran'];?>">
</td></tr>
...
<td align="center" class="pink">kode cucian keluar</td>
              <td>:</td>
          <td align="center">
              <input type="text" name="kd_ck" value="<?php echo $upd['kd_ck'];?>">
</td></tr>
...
<td align="center" class="pink">no telepon</td>
              <td>:</td>
          <td align="center">
              <input type="text" name="no_telepon" value="<?php echo $upd['no_telepon'];?>">
</td></tr>
