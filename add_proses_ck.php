<?php
   ...
   $value_nama1_cek = $_POST['tgl_ck'];
   $value_bagian_cek = $_POST['jenis_laundry'];
   $value_bagian_cek1 = $_POST['qty'];

   $cek_id = mysqli_query($koneksi,"select *  from cucian_keluar where kd_ck = '$random_data_id'");
 $cek_validasi = mysqli_num_rows($cek_id);
   
   $perintah_sql = mysqli_query(
    $koneksi,
    "insert into cucian_keluar values('$value_id', '$value_nama_cek ', '$value_nama1_cek ',' $value_bagian_cek',' $value_bagian_cek1')"
   );
