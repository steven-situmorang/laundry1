...
$upd_barang= mysqli_query($koneksi,"select  *  from konsumen where kd_konsumen ='$id_update_barang' ");
...
<div> 
  ...
  <form action="edit_proses_konsumen.php" class="form-container" method="post" align="center">
    <h1>Edit</h1>
    ...
    <table border="0" align="center">
          <tr>
              ...
              <td>:</td>
          <td align="center">
              <input readonly type="text" name="kd_konsumen" value="<?php echo $upd['kd_konsumen'];?>">
</td></tr>
...
<td align="center" class="pink">alamat</td>
              <td>:</td>
          <td align="center">
              <input type="text" name="alamat" value="<?php echo $upd['alamat'];?>">
</td></tr>
<td align="center" class="pink">no telepon</td>
              <td>:</td>
          <td align="center">
              <input type="text" name="no_telp" value="<?php echo $upd['no_telp'];?>">
</td></tr>
<tr>
    <td>
